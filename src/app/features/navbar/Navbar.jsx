                ...
                <div className="flex h-16 items-center justify-between">
                  ...
                  <div className="hidden md:block">
                    <div className="ml-4 flex items-center md:ml-6">
                      ...
                      <span className="inline-flex items-center rounded-full bg-red-50 px-2 py-1  mb-5 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10">
        3
      </span>
                      {/* Profile dropdown */}
              ...
              <Disclosure.Panel className="md:hidden">
                ...
                <div className="border-t border-gray-700 pb-3 pt-4">
                  <div className="flex items-center px-5">
                    ...
                    <button
                      type="button"
                      className=" flex-shrink-0 rounded-full -mr-3 bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                    >
